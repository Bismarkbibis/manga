...
//	}
	...
	public Manga insertMangaAdmin(String numSeri, String nom, String description, String titre, int nombrePage,String imageNum, int tom, String auteur, String genre, String statut, Date dateSortieManag, String langue,
...
// a discuter
		...
		if (!numSeriMaanga.isPresent()) {
			...
			if (catalogue01.isPresent()) {
				...
				erreurs.put("Destination introvable","page introvable veuiller verifier votre choix de catalogur 1: Inviter 2: Client 3: Abonne");
			}
			// save manga
